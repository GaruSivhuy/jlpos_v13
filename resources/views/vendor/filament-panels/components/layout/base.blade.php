...
>
    <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Siemreap&family=Moul&family=Battambang&display=swap" rel="stylesheet">
        ...
        <style>
            ...
            :root {
                --font-family: 'Source Sans Pro', 'Helvetica Neue', 'Siemreap', Helvetica, Arial, sans-serif;
                --sidebar-width: {{ filament()->getSidebarWidth() }};
                --collapsed-sidebar-width: {{ filament()->getCollapsedSidebarWidth() }};
                --default-theme-mode: {{ filament()->getDefaultThemeMode()->value }};
            }
