    ...
    public static function configure(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                TextColumn::make('st_code')->label(__('global.st_code'))->searchable()->sortable(),
                TextColumn::make('transfer_date')->label(__('global.transfer_date'))->searchable()->sortable(),
                TextColumn::make('fromLocation.name_kh')->label(__('global.from_location')),
                TextColumn::make('toLocation.name_kh')->label(__('global.to_location')),
        ...
        return Action::make('submit')
            ...
            ->action(function ($record) {
                ...
                try {
                    ...
                    foreach ($record->stockTransferDetails as $detail) {
