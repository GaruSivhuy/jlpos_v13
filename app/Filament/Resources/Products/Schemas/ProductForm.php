                        ...
                        Grid::make()
                            ...
                            ->schema([
                                ...
                                Select::make('metrics')
                                    ...
                                    ->options(auth()->user()->is_admin
                                        ? Metric::select(DB::raw('CONCAT(name_kh, " (", (select name_kh from branch where id = metrics.branch_id), ") ") AS metric_name'), 'id')->branch()->pluck('metric_name', 'id')->toArray()
                                        : Metric::select(DB::raw('CONCAT(name_kh) AS metric_name'), 'id')->branch()->pluck('metric_name', 'id')->toArray())
                                    ->multiple()
                                    ->searchable()
                                    ->required()
                                ...
                                Select::make('remarks')
                                    ...
                                    ->options(auth()->user()->is_admin
                                        ? Remark::select(DB::raw('CONCAT(name_kh, " (", (select name_kh from branch where id = remarks.branch_id), ") ") AS remarkable_name'), 'id')->pluck('remarkable_name', 'id')->toArray()
                                        : Remark::select(DB::raw('CONCAT(name_kh) AS remarkable_name'), 'id')->branch()->pluck('remarkable_name', 'id')->toArray())
                                    ->multiple()
                                    ->searchable()
