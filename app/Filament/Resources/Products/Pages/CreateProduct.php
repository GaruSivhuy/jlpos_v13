...
class CreateProduct extends BaseCreateRecord
{
    ...
    {
        return __("global.create")." ".__("global.product");
    }   

    protected function afterCreate(): void
    {
        $record = $this->record;
        $barcode = $this->data['pbar_code'] ? $this->data['pbar_code'] : "PID-" . str_pad($record->id, env("ID_PAD_LENGTH", 4), "0", STR_PAD_LEFT);
        $record->pbar_code = $barcode;
        $record->save();
    }
