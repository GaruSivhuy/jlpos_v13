...
use App\Stevebauman\Inventory\Exceptions\InvalidSupplierException;
use App\Stevebauman\Inventory\Exceptions\SkuAlreadyExistsException;
use App\Stevebauman\Inventory\Exceptions\StockAlreadyExistsException;
...
trait InventoryTrait
{
     ...
     */
    public function createStockOnLocation($quantity, $location, $metric, $reason = '', $cost = 0, $aisle = null, $row = null, $bin = null)
    {
        ...
        try {
             ...
             */
            if ($this->getStockFromLocation($location, $metric)) {
     ...
     * @throws StockNotFoundException
     */
    public function takeFromLocation($quantity, $location, $metric = null, $reason = '')
    {
        /*
        ...
        if (is_array($location)) {
            return $this->takeFromManyLocations($quantity, $location, $metric, $reason);
        } else {
            $stock = $this->getStockFromLocation($location, $metric);
     ...
     * @throws StockNotFoundException
     */
    public function takeFromManyLocations($quantity, $locations = [], $metric = null, $reason = '')
    {
        $stocks = [];
     ...
     * @return array
     */
    public function removeFromLocation($quantity, $location, $metric = null, $reason = '')
    {
        return $this->takeFromLocation($quantity, $location, $metric, $reason);
    }
     ...
     * @return array
     */
    public function removeFromManyLocations($quantity, $locations = [], $metric = null, $reason = '')
    {
        return $this->takeFromManyLocations($quantity, $locations, $metric, $reason);
    }
     ...
     * @throws StockNotFoundException
     */
    public function putToLocation($quantity, $location, $metric = null, $reason = '', $cost = 0)
    {
        if (is_array($location)) {
            return $this->putToManyLocations($quantity, $location, $metric);
        } else {
            $stock = $this->getStockFromLocation($location, $metric);
     ...
     * @throws StockNotFoundException
     */
    public function putToManyLocations($quantity, $locations = [], $metric = null, $reason = '', $cost = 0)
    {
        $stocks = [];
     ...
     * @return array
     */
    public function addToLocation($quantity, $location, $metric = null, $reason = '', $cost = 0)
    {
        return $this->putToLocation($quantity, $location, $metric, $reason, $cost);
    }
     ...
     * @return array
     */
    public function addToManyLocations($quantity, $locations = [], $metric = null, $reason = '', $cost = 0)
    {
        return $this->putToManyLocations($quantity, $locations, $metric, $reason, $cost);
    }
     ...
     * @throws StockNotFoundException
     */
    public function getStockFromLocation($location, $metric = null)
    {
        $location = $this->getLocation($location);
        ...
        $stock = $this->stocks()
            ...
            ->when($metric, fn ($query) => $query->where('metric_id', $metric->getKey()))
            ->first();
